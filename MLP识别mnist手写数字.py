...
"""
http://blog.csdn.net/szj_huhu/article/details/73507160
利用多层感知器对mnist数据集分类
精度比logistic高
"""
#加载数据
...
def multilayer_perception(inputs,in_size,out_size,activation_function=None):
    with tf.variable_scope('layer1'):
        weights = tf.Variable(tf.random_normal([in_size,out_size],mean=0,stddev=1),name="weights")
...
l1 = multilayer_perception(xs,784,256,activation_function=tf.nn.relu) #隐藏层 激励函数为sigmoid,ReLU
