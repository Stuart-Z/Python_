...
regularizer = tf.contrib.layers.l2_regularizer(0.01)   #这是学习率？
...
with tf.Session() as sess:
    ...
    save_path = saver.save(sess,"./save/model_1.ckpt") #后来加上的存储模型
    accuracy = tf.reduce_mean(tf.cast(correct_prediction, "float"))
    print("Testing Accuracy:", accuracy.eval(feed_dict={x:test_data,y_:test_label}))
